...
class TfExampleDecoderTest(tf.test.TestCase):
    ...
    def testDecodeJpegImage(self):
        ...
        self.assertAllEqual([4, 5], tensor_dict[fields.InputDataFields.
                            original_image_spatial_shape])
        self.assertEqual('image_id'.encode(), tensor_dict[fields.InputDataFields.source_id])
    ...
    def testDecodeImageKeyAndFilename(self):
        ...
        self.assertEqual('abc'.encode(), tensor_dict[fields.InputDataFields.key])
        self.assertEqual('filename'.encode(), tensor_dict[fields.InputDataFields.filename])
